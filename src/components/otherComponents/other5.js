            ...
            <Container style={{ marginBottom: '20px' }}>
                <Row>
                    <Col xs={12} style={{ textAlign: 'left', fontWeight: 'bold' }}>
                        <span>五、 <span style={{ textDecoration: 'underline' }}>重 大 會 計 判 斷 、估 計 及 假 設 不 確 定 性 之 主 要 來 源 </span></span>
                    </Col>
                </Row>
                <Row style={{ marginTop: '10px' }}>
                    <Col xs={{ span: 10, offset: 1 }} >
                        <p contenteditable="true">
                            ...
                            經 驗 及 其 他 因 子 持 續 評 估 及 調 整 。
                            部 分 項 目 之 會 計 政 策 與 管 理 階 層 之 判 斷 對 本 行 及 子 行 財 務 報 告 認 列 金 額 之 影 響
                            重 大 ， 說 明 如 下 ：
                        </p>
                    </Col>
                </Row>
                <Row style={{ marginTop: '10px' }}>
                    ...
                    <Col xs={10} >
                        ...
                        <p contenteditable="true">
                            ...
                            以 適 當 假 設 衡 量。當 採 用 評 價 模 型 決 定 公 允 價 值 時，所 有 模 型 須 經 校 準 以 確
                            保 產 出 結 果 反 映 實 際 資 料 與 市 場 價 格 ， 惟 盡 可 能 只 採 用 可 觀 察 資 料 。
                            本 行 及 子 行 於 公 允 價 值 衡 量 主 要 係 參 考 類 似 產 業 可 類 比 上 市 ( 櫃 )公 司 最 近
                            期 公 告 之 市 場 乘 數 做 為 計 算 參 考 依 據，以 及 考 量 市 場 流 通 性 或 風 險 特 殊 性 所
                            作 折 價。任 何 判 斷 及 估 計 之 變 動，均 可 能 會 影 響 其 公 允 價 值 之 衡 量。有 關 金
                            融 工 具 公 允 價 值 之 說 明 ， 請 詳 附 註 七 。
                        </p>
                    </Col>
                </Row>
                <Row style={{ marginTop: '10px' }}>
                        ...
                        <Row style={{ marginTop: '10px' }}>
                            ...
                            <Col xs={11} >
                                <p contenteditable="true">
                                    ...
                                    能 性 及 損 失 ）。 附 註 八 ( 三 )說 明 預 期 信 用 損 失 衡 量 中 使 用 的 參 數、 假 設 和 估
