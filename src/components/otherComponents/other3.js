            ...
            <Container style={{marginBottom: '20px'}}>
                ...
                <Row style={{ marginTop: '10px' }}>
                    ...
                    <Col md={{ span: 7, offset: 1 }} className="contentunderline">
                        <span contentEditable={true} suppressContentEditableWarning={true}>新發佈/修正/修訂準則及解釋</span>
                    </Col>
                    <Col md={3} className="contentunderline" style={{marginLeft: '5px'}}>
                        <span contentEditable={true} suppressContentEditableWarning={true}>國際會計準則理事會發佈之生效日</span>
                    </Col>
                    <Col md={{ span: 7, offset: 1 }} >
                        <span contentEditable={true} suppressContentEditableWarning={true}>國際財務報導準則第9號之修正「具負補償之提前還款特性」</span>
                    </Col>
                    <Col md={3} style={{marginLeft: '5px'}}>
                        <span contentEditable={true} suppressContentEditableWarning={true}>民國108年1月1日</span>
                    </Col>
                    <Col md={{ span: 7, offset: 1 }}>
                        <span contentEditable={true} suppressContentEditableWarning={true}>國際財務報導準則第16號「租賃」</span>
                    </Col>
                    <Col md={3} style={{marginLeft: '5px'}}>
                        <span contentEditable={true} suppressContentEditableWarning={true}>民國108年1月1日</span>
                    </Col>
                    <Col md={{ span: 7, offset: 1 }} >
                        <span contentEditable={true} suppressContentEditableWarning={true}>國際會計準則第19號之修正「計畫之修正、縮減或清償」</span>
                    </Col>
                    <Col md={3} style={{marginLeft: '5px'}}>
                        <span contentEditable={true} suppressContentEditableWarning={true}>民國108年1月1日</span>
                    </Col>
